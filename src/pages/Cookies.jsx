...
function webSections() {
  return [
    ...
    },
    {
      ...
      content: (
        <ul className="list-disc pl-5 space-y-1">
          <li><strong>RevenueCat</strong> — payment processing for subscriptions and event tickets.</li>
    ...
    },
    {
      ...
      content: (
        <>
          <p className="mb-2">When you first visit Kalunez on the web, we show a cookie banner where you can:</p>
          <ul className="list-disc pl-5 space-y-1">
...
function nativeSections() {
  return [
    {
      title: '1. What we store on this device',
      content: (
        <p>
          The Kalunez iOS/Android app uses only essential local storage needed to sign you in, keep your session secure,
          and run playback. We do not show a cookie or tracking consent banner in the app, and we do not enable optional
          analytics or advertising cookies for tracking across other companies&apos; apps or websites.
        </p>
      ),
    },
    {
      title: '2. What we do not use in the app',
      content: (
        <ul className="list-disc pl-5 space-y-1">
          <li>No optional analytics cookies (PostHog is disabled in the native app).</li>
          <li>No session-replay cookies.</li>
          <li>No App Tracking Transparency prompt, because we do not track users across other apps or websites.</li>
        </ul>
      ),
    },
    {
      title: '3. Payments and streaming',
      content: (
        <ul className="list-disc pl-5 space-y-1">
          <li><strong>RevenueCat / Apple</strong> — process subscriptions and event tickets.</li>
          <li><strong>LiveKit / Mux</strong> — live streaming when you watch or broadcast.</li>
          <li><strong>Supabase</strong> — authentication and backend services.</li>
        </ul>
      ),
    },
    {
      ...
      content: (
        <>
          <p>For the website (kalunez.com), a separate cookie banner may appear because web analytics can be enabled with consent there.</p>
          <p className="mt-3">Questions: <a href="mailto:support@kalunez.com" className="text-purple-400 hover:underline">support@kalunez.com</a></p>
        </>
      ),
    },
...
export default function Cookies() {
  const sections = Capacitor.isNativePlatform() ? nativeSections() : webSections();
